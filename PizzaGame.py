...
class Pan(games.Sprite):
    """
    Сковорода, в которую игрок ловит пиццу.
    """
    ...
    def __init__(self):
        """
        Инициализирует объект Pan и создает объет Text для отображения счета.
        """
    ...
    def check_catch(self):
        """
        Проверяет, поймал ли игрок пиццу.
        """
...
class Chef(games.Sprite):
    """
    Повар, который двигается влево-вправо и разбрасывает пиццу.
    """
